        ...
        CancellationToken cancellationToken)
    {
        ...
        if (string.IsNullOrWhiteSpace(sessionId) || !_sessions.TryGetValue(sessionId, out var state))
        {
            return Task.FromResult<IReadOnlyDictionary<string, object?>>(new Dictionary<string, object?>
            {
                ...
                ["lastPeerMediaRuntimeRunning"] = null,
                ["lastPeerMediaRuntimeState"] = null,
                ["lastPeerMediaRuntimeFailureReason"] = null,
                ["lastPeerMediaRuntimeEngine"] = null,
                ["lastPeerMediaSessionEvidence"] = null,
                ["lastPeerMediaRuntimeSessionEvidence"] = null,
                ["lastPeerMediaSessionState"] = null,
                ["lastPeerMediaVideoTrackState"] = null,
                ["lastPeerMediaAudioTrackState"] = null,
                ["lastPeerMediaSessionObservedAtUtc"] = null,
                ["lastPeerMediaBackendAutoStart"] = null,
                ["lastPeerMediaBackendRunning"] = null,
                ["lastPeerMediaBackendState"] = null,
                ["lastPeerMediaBackendReportedAtUtc"] = null,
                ["lastPeerMediaBackendPid"] = null,
                ["lastPeerMediaBackendUptimeSec"] = null,
                ["lastPeerMediaBackendLastLine"] = null,
                ["lastPeerMediaBackendExecutable"] = null,
                ["lastPeerMediaBackendWorkingDirectory"] = null,
                ["lastPeerMediaBackendProbeEndpoints"] = null,
    ...
    private sealed class SessionRelayState
    {
        ...
        public IReadOnlyDictionary<string, object?> GetMetrics(string? endpointId, DateTimeOffset nowUtc, TimeSpan peerStaleAfter)
        {
            ...
            return new Dictionary<string, object?>
            {
                ...
                ["lastPeerMediaPlaybackUrl"] = TryReadMetadataValue(latestMetadata, "mediaPlaybackUrl"),
                ...
                ["lastPeerMediaRuntimeRunning"] = TryReadMetadataValue(latestMetadata, "mediaRuntimeRunning"),
                ["lastPeerMediaRuntimeState"] = TryReadMetadataValue(latestMetadata, "mediaRuntimeState"),
                ["lastPeerMediaRuntimeFailureReason"] = TryReadMetadataValue(latestMetadata, "mediaRuntimeFailureReason"),
                ["lastPeerMediaSessionEvidence"] = TryReadMetadataValue(latestMetadata, "mediaSessionEvidence"),
                ["lastPeerMediaRuntimeSessionEvidence"] = TryReadMetadataValue(latestMetadata, "mediaRuntimeSessionEvidence"),
                ["lastPeerMediaSessionState"] = TryReadMetadataValue(latestMetadata, "mediaSessionState"),
                ["lastPeerMediaVideoTrackState"] = TryReadMetadataValue(latestMetadata, "mediaVideoTrackState"),
                ["lastPeerMediaAudioTrackState"] = TryReadMetadataValue(latestMetadata, "mediaAudioTrackState"),
                ["lastPeerMediaSessionObservedAtUtc"] = TryReadMetadataValue(latestMetadata, "mediaSessionObservedAtUtc"),
                ["lastPeerMediaBackendAutoStart"] = TryReadMetadataValue(latestMetadata, "mediaBackendAutoStart"),
                ["lastPeerMediaBackendRunning"] = TryReadMetadataValue(latestMetadata, "mediaBackendRunning"),
                ["lastPeerMediaBackendState"] = TryReadMetadataValue(latestMetadata, "mediaBackendState"),
                ["lastPeerMediaBackendReportedAtUtc"] = TryReadMetadataValue(latestMetadata, "mediaBackendReportedAtUtc"),
                ["lastPeerMediaBackendPid"] = TryReadMetadataValue(latestMetadata, "mediaBackendPid"),
                ["lastPeerMediaBackendUptimeSec"] = TryReadMetadataValue(latestMetadata, "mediaBackendUptimeSec"),
                ["lastPeerMediaBackendLastLine"] = TryReadMetadataValue(latestMetadata, "mediaBackendLastLine"),
                ["lastPeerMediaBackendExecutable"] = TryReadMetadataValue(latestMetadata, "mediaBackendExecutable"),
                ["lastPeerMediaBackendWorkingDirectory"] = TryReadMetadataValue(latestMetadata, "mediaBackendWorkingDirectory"),
                ["lastPeerMediaBackendProbeEndpoints"] = TryReadMetadataValue(latestMetadata, "mediaBackendProbeEndpoints"),
